...
import AdminInstagramTab from '@/components/admin/AdminInstagramTab';
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <TabsList className="inline-flex w-full mb-8 overflow-x-auto">
            ...
            <TabsTrigger value="instagram">IA Instagram</TabsTrigger>
            ...
            <TabsTrigger value="products-cases">Cases</TabsTrigger>
          ...
          <TabsContent value="products-cases">
            <AdminProductsCasesTab />
          </TabsContent>
