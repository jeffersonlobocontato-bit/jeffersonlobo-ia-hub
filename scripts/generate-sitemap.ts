...
function writeLlmsTxt(blogPosts: BlogPostRow[]) {
  ...
  lines.push('');
  lines.push('> Palestrante, autor e consultor em Inteligência Artificial aplicada a marketing, negócios e lideranças. Gerente Executivo de Marketing do Sistema Fiep (Federação das Indústrias do Estado do Paraná), referência nacional em IA generativa para o ambiente corporativo — com foco em agentes de IA com identidade autoral (DNA de marca) e na orquestração de fluxos de marketing com IA, superando a "indústria de prompts" genéricos.');
  lines.push('');
  lines.push('## Sobre');
  lines.push('');
  lines.push('Jefferson Lobo é palestrante, autor e consultor em Inteligência Artificial aplicada a marketing, negócios e lideranças. Atua como Gerente Executivo de Marketing do Sistema Fiep, combinando visão executiva de marketing em uma grande instituição com prática técnica em IA generativa.');
  lines.push('');
  ...
  lines.push('');
  lines.push('Base em Curitiba/PR. Atende todo o Brasil, presencialmente e online, ministrando keynotes, workshops corporativos e consultorias estratégicas para diretores, gerentes e times de marketing.');
  lines.push('');
  lines.push('## Serviços');
  lines.push('');
  ...
  lines.push('');
  lines.push(`- [O código invisível dos superagentes de inteligência artificial](${BASE_URL}/livro-del): livro de Jefferson Lobo sobre o Método DEL — como treinar agentes de IA com fidelidade autoral, sem programar. Disponível em e-book (R$ 47) e impresso.`);
  lines.push(`- [Materiais gratuitos do livro](${BASE_URL}/materiais): checklists de auditoria de fidelidade autoral e templates operacionais do Método DEL, sem cadastro.`);
  lines.push('');
  lines.push('## Recursos gratuitos');
  lines.push('');
  lines.push(`- [Teste de Maturidade em IA](${BASE_URL}/teste-ia): diagnóstico gratuito do nível de maturidade em IA de uma empresa ou profissional, com relatório em PDF.`);
  lines.push('');
  lines.push('## Imprensa');
  lines.push('');
  ...
  lines.push('');
  lines.push('- Jefferson Lobo é palestrante, autor e consultor brasileiro em Inteligência Artificial aplicada a marketing, negócios e lideranças, e Gerente Executivo de Marketing do Sistema Fiep.');
  ...
  lines.push(`- Briefing de proposta: ${BASE_URL}/#contato`);
  lines.push('');
